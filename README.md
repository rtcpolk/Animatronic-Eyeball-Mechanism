...
The class I am taking had us install `ROS2` on Ubuntu 22.04. `ROS2` and `microORS` seem to have better support for Ubuntu, but should work with Windows and macOS. The following steps should still apply but the commands will be different.
